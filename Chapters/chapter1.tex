...
Infine la direttiva \code{CMD} specifica il comando che verrà eseguito una volta finito il setup dell'ambiente, in questo caso viene eseguito \code{Dandelion.jar} con un particolare
